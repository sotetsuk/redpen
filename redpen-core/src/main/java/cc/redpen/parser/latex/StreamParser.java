...
public class StreamParser {
    ...
    /*package*/ static class Parsing {
        ...
        public static List<Token> collapse(final List<Token> tokens) {
            ...
            final Pattern ignores = Pattern.compile(".?(?:space|fill)\\*?|phantom|documentclass|usepackage|author|date|label|ref|cite|citet|citep|citeauthor|url|biblio.*|includegraphics");
            try {
                while (true) {
