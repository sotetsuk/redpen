...
/**
 * Validate input sentences contain spoken expression.
 */
public final class SpokenExpressionValidator extends DictionaryValidator {
    public SpokenExpressionValidator() {
        super("spoken-expression/spoken-expression");
    }
